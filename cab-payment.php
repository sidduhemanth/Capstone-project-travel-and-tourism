...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_payment'])) {
    try {
        ...
        // Generate booking ID
        $booking_id = 'CAB' . rand(10000, 99999);
        ...
        $stmt->execute([
            ...
            'total_amount' => 900.00, // Fixed amount for demo, you can modify this
        ...
        $_SESSION['booking_details'] = [
            ...
            'pickup_address' => $_POST['pickup_address'],
            'destination_address' => $_POST['destination_address'],
            'total_amount' => 1500.00 // Fixed amount for demo
        ];
...
<head>
    ...
    <title>Cab Payment - Travel App</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="app-container">
        <header class="header">
            <a href="cab.php" class="back-button">←</a>
            <h1>Cab Payment</h1>
        </header>
