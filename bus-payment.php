...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_payment'])) {
    try {
        ...
        // Generate booking ID
        $booking_id = 'BUS' . rand(10000, 99999);
...
$stmt->execute([
    ...
    'total_amount' => isset($_POST['total_price']) ? floatval($_POST['total_price']) : 0, // Dynamic amount from bus.php
    ...
    'card_last_four' => $card_last_four
        ...
        $_SESSION['booking_details'] = [
            ...
            'pickup_address' => $_POST['pickup_address'],
            'destination_address' => $_POST['destination_address'],
            'total_amount' => 3500.00 // Fixed amount for demo
        ];
...
<head>
    ...
    <title>bus Payment - Travel App</title>
    <style>
        * {
            margin: 0;
            padding: 0;
